...
export const genesisQuestions: Question[] = [
    {
        ...
        funFact: "The Hebrew word for 'created' used here is 'bara', which is only ever used with God as the subject, implying creation out of nothing (ex nihilo)."
    },
    {
        id: 'gen_2',
        ...
        funFact: "Light was created on Day 1, but the sun, moon, and stars weren't created until Day 4, showing that God Himself is the ultimate source of light."
    },
    {
        id: 'gen_3',
        ...
        funFact: "In Hebrew, 'Adam' sounds like 'Adamah' (earth/ground), highlighting humanity's connection to the physical earth."
    },
    {
        id: 'gen_4',
