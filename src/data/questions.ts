...
export const getQuestionsForBook = (bookId: string): Question[] => {
    switch (bookId) {
        ...
        case 'daily': {
            const allQ = [
                ...genesisQuestions, ...matthewQuestions, ...johnQuestions, ...actsQuestions, ...psalmsQuestions, ...proverbsQuestions, ...revelationQuestions, ...romansQuestions, ...corinthians1Questions
            ];
            return allQ;
        }
        default:
