        ...
        >
            {isPrimary ? (
                <LinearGradient
                    ...
                    style={[styles.container, styles.primaryGradient, style]}
                >
                ...
                <View style={[styles.container, styles.errorBorder, style]}>
                ...
                <LinearGradient
                    ...
                    style={[styles.container, styles.secondaryBorder, style]}
                >
